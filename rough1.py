...
HUGGINGFACE_API_KEY = "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"
            ...
            with spinner("Processing extracted files..."):
                ...
                for file in extracted_images:
                    ...
                    if structured_data:
                        ...
                        # Replace currency symbol with currency name
                        currency_symbols = {
                            "$": "USD",
                            "₹": "INR",
                            "€": "EUR",
                        ...
                        # Extract currency symbol and convert to currency name
                        ...
                        # Remove the symbol from the Bill Amount value
